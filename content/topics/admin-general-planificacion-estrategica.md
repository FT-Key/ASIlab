---
title: Administracion General y Planificacion Estrategica
emoji: "🎯"
accent: "#3B82F6"
category: admin-general
difficulty: intermedio
order: 15
description: Conceptos fundamentales de administracion general: la funcion administrativa (PODIO), estrategia vs tactica, FODA y PESTEL, objetivos SMART, las 4 etapas de la planificacion estrategica, modelo de negocio, estrategias competitivas y cadena de valor. Base para decidir en organizaciones.
...
| Factor | Interno/Externo | Descripcion | Ejemplo (Logistica Andina) |
|--------|-----------------|-------------|----------------------------|
| **Fortalezas (F)** | Interno | Que hace bien la organizacion? | Red de bodegas propia, equipo capacitado |
| **Debilidades (D)** | Interno | Donde le falta capacidad? | Deuda tecnica, presupuesto de TI limitado |
| **Oportunidades (O)** | Externo | Que oportunidades aprovechar? | Auge del e-commerce, cloud, IA |
| **Amenazas (A)** | Externo | Que la puede perjudicar? | Competencia con mejores apps, regulacion |

:::callout danger
El error mas comun es confundir debilidades con amenazas o fortalezas con oportunidades. Fortalezas y debilidades son **internas** (la empresa las controla); oportunidades y amenazas son **externas** (no las controla).
:::
...
| Dimension | Que analiza | Ejemplo (Logistica Andina) |
|-----------|-------------|----------------------------|
| **Politico** | Politicas y gobierno | Incentivos al comercio electronico y a mipymes |
| **Economico** | Costos, inflacion, tipo de cambio | Costo del combustible y del cloud |
| **Social** | Tendencias de la sociedad | Crecimiento de compras online y domicilios |
...
| **Legal** | Leyes y regulaciones | Proteccion de datos, normativa laboral |

:::callout idea FODA + PESTEL
El **PESTEL** mira afuera (macro-entorno) y el **FODA** combina adentro y afuera para decidir. Juntos son la base del analisis estrategico.
:::
...
:::callout info
NO SMART: "Mejorar las ventas". SMART: "Aumentar las ventas en 15% en el proximo trimestre con campanas de marketing digital".
:::
...
:::quiz Admin General - Nivel 1 (memoria)
1. ¿Que significa PODIO? || Plan, Organizar, Dirigir, Integrar, Operar || Planificar, Organizar, Dirigir, Integrar, Controlar || Produccion, Organizacion, Direccion, Informacion, Control || Presupuesto, Organizacion, Desarrollo, Implementacion, Control || 1 || PODIO = Planificar, Organizar, Dirigir, Integrar y Controlar.
2. ¿Cuantas dimensiones analiza el PESTEL? || 3 || 4 || 5 || 6 || 3 || Politico, economico, social, tecnologico, ecologico y legal.
3. ¿Que significan las siglas SMART? || Simple, Medible, Amplio, Real, Temporal || Especifico, Medible, Alcanzable, Relevante, Temporal || Solo, Medible, Actual, Real || Sistema, Meta, Accion, Resultado, Tiempo || 1 || Specific, Measurable, Achievable, Relevant, Time-bound.
4. En el FODA, las amenazas son factores: || Internos || Externos || Ambos || Ninguno || 1 || Son externos: la empresa no los controla.
5. ¿Cuantas etapas tiene la planificacion estrategica segun el material? || 2 || 3 || 4 || 5 || 2 || Cuatro: basica, atencion al tiempo, potenciacion y aplicacion.
6. ¿Que estudia la administracion? || Solo las finanzas || Como las organizaciones alcanzan objetivos con eficiencia y eficacia || Solo el marketing || Solo el personal || 1 || Es la ciencia de alcanzar objetivos usando recursos.
:::

### Nivel 2 - Comprension

:::quiz Admin General - Nivel 2 (comprension)
...
2. ¿Por que el PESTEL complementa al FODA? || Porque son iguales || Porque el PESTEL analiza el macro-entorno externo que alimenta el analisis FODA || Porque reemplaza al FODA || Porque es financiero || 1 || PESTEL da el contexto externo.
3. Una deuda tecnica es una: || Oportunidad externa || Debilidad interna || Amenaza externa || Fortaleza || 1 || Es interna: la empresa la controla.
4. Un objetivo "mejorar la calidad del servicio" NO es SMART porque: || Es muy caro || No es medible ni temporal || Es de TI || Lo dijo el gerente || 1 || Le faltan medicion y plazo.
5. ¿Que funcion administrativa define objetivos y estrategias? || Controlar || Planificar || Organizar || Dirigir || 1 || Planificar es la primera funcion.
6. La estrategia responde a: || Hacer las cosas correctamente || Hacer las cosas correctas || Controlar || Organizar || 1 || La estrategia define que es lo correcto.
7. ¿Cual es una estrategia competitiva generica de Thompson? || Liderazgo en costos || Duplicar precios || Reducir personal || Eliminar la competencia || 0 || Liderazgo en costos totales mas bajos.
8. ¿Que tipo de planificacion hace la alta direccion a largo plazo? || Operativa || Tactica || Estrategica || Diaria || 2 || La estrategica es de largo plazo y alta direccion.
:::

### Nivel 3 - Escenarios

:::quiz Admin General - Nivel 3 (escenarios)
1. Logistica Andina analiza el auge del e-commerce. En el FODA es: || Fortaleza || Debilidad || Oportunidad || Amenaza || 2 || Viene del entorno y se puede aprovechar.
2. Una nueva ley de proteccion de datos es, en el PESTEL: || Factor politico || Factor legal || Factor social || Factor tecnologico || 1 || Es la dimension Legal.
3. La empresa define "aumentar ventas 15% en 6 meses". ¿Que aplico? || Un objetivo SMART || Una amenaza || Una debilidad || Un plan operativo || 0 || Especifico, medible, alcanzable, relevante y temporal.
4. El gerente define horarios y tareas del dia. ¿Que planificacion aplica? || Estrategica || Tactica || Operativa || Vision || 2 || Es planificacion operativa.
5. La empresa decide operar con los costos mas bajos del sector. ¿Que estrategia usa? || Diferenciacion || Liderazgo en costos || Enfoque || Hibrida || 1 || Liderazgo en costos totales mas bajos.
6. Se define la razon de ser y hacia donde va la empresa. ¿Que etapa es? || Basica || Atencion al tiempo || Potenciacion || Aplicacion || 0 || La etapa basica define mision y vision.
7. Un objetivo que no se puede medir ni tiene plazo es: || SMART || No SMART || Una fortaleza || Un KPI || 1 || Le faltan M y T.
8. La empresa capacita al equipo en nuevas herramientas. ¿Estrategia o tactica? || Estrategia || Tactica || Vision || Mision || 1 || Es una accion de corto plazo: tactica.
:::
...
:::match Relaciona conceptos de administracion
...
:::truefalse Administracion General
...
:::essay Administracion General
1. Explique la diferencia entre el analisis FODA y el PESTEL, y como se complementan. De un ejemplo de cada cuadrante del FODA para una empresa de logistica. || Pista: FODA = interno (F/D) + externo (O/A); PESTEL = macro-entorno externo en 6 dimensiones. || Respuesta modelo: El FODA evalua factores internos y externos de la organizacion: Fortalezas (red de bodegas propia, equipo capacitado), Debilidades (deuda tecnica, presupuesto limitado), Oportunidades (auge del e-commerce, cloud, IA) y Amenazas (competidores con mejores apps, regulacion). El PESTEL analiza el entorno externo en seis dimensiones (politico, economico, social, tecnologico, ecologico y legal) y complementa al FODA aportando el contexto macro. Juntos permiten decidir la estrategia: el PESTEL da el escenario y el FODA define como aprovechar o defenderse. || [rúbrica: Diferencia FODA y PESTEL, Da ejemplo por cuadrante, Explica la complementariedad, Redaccion y claridad]
